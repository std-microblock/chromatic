// This file is generated by Breeze.JS Bindgen
// (https://github.com/breeze-shell/breeze-js-bindgen) Do not modify this file
// manually!
...
template <typename T> struct js_bind {
...
template <> struct qjs::js_traits<chromatic::js::console> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::console &val) noexcept {
...
template <> struct qjs::js_traits<chromatic::js::ScanMatch> {
  static chromatic::js::ScanMatch unwrap(JSContext *ctx, JSValueConst v) {
    ...
    obj.address = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "address"));
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::ScanMatch &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "address",
                      js_traits<std::string>::wrap(ctx, val.address));
...
template <> struct qjs::js_traits<chromatic::js::NativeMemory> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::NativeMemory &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeMemory> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeMemory>("NativeMemory")
        ...
        .static_fun<&chromatic::js::NativeMemory::safeReadMemory>(
            "safeReadMemory")
        .static_fun<&chromatic::js::NativeMemory::writeMemory>("writeMemory")
        .static_fun<&chromatic::js::NativeMemory::allocateMemory>(
            "allocateMemory")
        .static_fun<&chromatic::js::NativeMemory::freeMemory>("freeMemory")
        .static_fun<&chromatic::js::NativeMemory::protectMemory>(
            "protectMemory")
        ...
        .static_fun<&chromatic::js::NativeMemory::scanMemoryAsync>(
            "scanMemoryAsync")
        .static_fun<&chromatic::js::NativeMemory::scanModuleAsync>(
            "scanModuleAsync");
  }
};
...
template <> struct qjs::js_traits<chromatic::js::ModuleInfo> {
  static chromatic::js::ModuleInfo unwrap(JSContext *ctx, JSValueConst v) {
    ...
    obj.name =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "name"));

    obj.base =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "base"));

    obj.size = js_traits<int>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "size"));

    obj.path =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "path"));

    return obj;
  }

  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::ModuleInfo &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "name",
                      js_traits<std::string>::wrap(ctx, val.name));

    JS_SetPropertyStr(ctx, obj, "base",
                      js_traits<std::string>::wrap(ctx, val.base));

    JS_SetPropertyStr(ctx, obj, "size", js_traits<int>::wrap(ctx, val.size));

    JS_SetPropertyStr(ctx, obj, "path",
                      js_traits<std::string>::wrap(ctx, val.path));
...
template <> struct qjs::js_traits<chromatic::js::RangeInfo> {
  static chromatic::js::RangeInfo unwrap(JSContext *ctx, JSValueConst v) {
    ...
    obj.protection = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "protection"));

    obj.filePath = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "filePath"));

    return obj;
  }

  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::RangeInfo &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
    ...
    JS_SetPropertyStr(ctx, obj, "protection",
                      js_traits<std::string>::wrap(ctx, val.protection));

    JS_SetPropertyStr(ctx, obj, "filePath",
                      js_traits<std::string>::wrap(ctx, val.filePath));
...
template <> struct qjs::js_traits<chromatic::js::ExportInfo> {
  static chromatic::js::ExportInfo unwrap(JSContext *ctx, JSValueConst v) {
    ...
    obj.type =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "type"));
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::ExportInfo &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "type",
                      js_traits<std::string>::wrap(ctx, val.type));
...
template <> struct qjs::js_traits<chromatic::js::NativeProcess> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::NativeProcess &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeProcess> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeProcess>("NativeProcess")
        .constructor<>()
        .static_fun<&chromatic::js::NativeProcess::getArchitecture>(
            "getArchitecture")
        .static_fun<&chromatic::js::NativeProcess::getPlatform>("getPlatform")
        .static_fun<&chromatic::js::NativeProcess::getPointerSize>(
            "getPointerSize")
        ...
        .static_fun<&chromatic::js::NativeProcess::getCurrentThreadId>(
            "getCurrentThreadId")
        .static_fun<&chromatic::js::NativeProcess::enumerateModules>(
            "enumerateModules")
        .static_fun<&chromatic::js::NativeProcess::enumerateRanges>(
            "enumerateRanges")
        .static_fun<&chromatic::js::NativeProcess::findExportByName>(
            "findExportByName")
        .static_fun<&chromatic::js::NativeProcess::findModuleByAddress>(
            "findModuleByAddress")
        .static_fun<&chromatic::js::NativeProcess::findModuleByName>(
            "findModuleByName")
        .static_fun<&chromatic::js::NativeProcess::enumerateExports>(
            "enumerateExports");
  }
};
...
template <> struct qjs::js_traits<chromatic::js::InstructionInfo> {
  static chromatic::js::InstructionInfo unwrap(JSContext *ctx, JSValueConst v) {
    ...
    obj.mnemonic = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "mnemonic"));

    obj.opStr =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "opStr"));

    obj.size = js_traits<int>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "size"));

    obj.bytes =
        js_traits<std::string>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "bytes"));

    obj.address = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "address"));

    obj.groups = js_traits<std::vector<int>>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "groups"));

    obj.regsRead = js_traits<std::vector<int>>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "regsRead"));

    obj.regsWrite = js_traits<std::vector<int>>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "regsWrite"));

    return obj;
  }

  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::InstructionInfo &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "mnemonic",
                      js_traits<std::string>::wrap(ctx, val.mnemonic));

    JS_SetPropertyStr(ctx, obj, "opStr",
                      js_traits<std::string>::wrap(ctx, val.opStr));

    JS_SetPropertyStr(ctx, obj, "size", js_traits<int>::wrap(ctx, val.size));

    JS_SetPropertyStr(ctx, obj, "bytes",
                      js_traits<std::string>::wrap(ctx, val.bytes));

    JS_SetPropertyStr(ctx, obj, "address",
                      js_traits<std::string>::wrap(ctx, val.address));

    JS_SetPropertyStr(ctx, obj, "groups",
                      js_traits<std::vector<int>>::wrap(ctx, val.groups));

    JS_SetPropertyStr(ctx, obj, "regsRead",
                      js_traits<std::vector<int>>::wrap(ctx, val.regsRead));

    JS_SetPropertyStr(ctx, obj, "regsWrite",
                      js_traits<std::vector<int>>::wrap(ctx, val.regsWrite));
...
template <> struct qjs::js_traits<chromatic::js::InstructionAnalysis> {
  static chromatic::js::InstructionAnalysis unwrap(JSContext *ctx,
                                                   JSValueConst v) {
    chromatic::js::InstructionAnalysis obj;

    obj.isBranch =
        js_traits<bool>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "isBranch"));

    obj.isCall =
        js_traits<bool>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "isCall"));

    obj.isRelative =
        js_traits<bool>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "isRelative"));

    obj.target = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "target"));

    obj.isPcRelative =
        js_traits<bool>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "isPcRelative"));
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::InstructionAnalysis &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "isBranch",
                      js_traits<bool>::wrap(ctx, val.isBranch));

    JS_SetPropertyStr(ctx, obj, "isCall",
                      js_traits<bool>::wrap(ctx, val.isCall));

    JS_SetPropertyStr(ctx, obj, "isRelative",
                      js_traits<bool>::wrap(ctx, val.isRelative));

    JS_SetPropertyStr(ctx, obj, "target",
                      js_traits<std::string>::wrap(ctx, val.target));

    JS_SetPropertyStr(ctx, obj, "isPcRelative",
                      js_traits<bool>::wrap(ctx, val.isPcRelative));
...
template <> struct qjs::js_traits<chromatic::js::XrefResult> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::XrefResult &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct qjs::js_traits<chromatic::js::NativeDisassembler> {
  static chromatic::js::NativeDisassembler unwrap(JSContext *ctx,
                                                  JSValueConst v) {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::NativeDisassembler &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeDisassembler> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeDisassembler>("NativeDisassembler")
        .constructor<>()
        .static_fun<&chromatic::js::NativeDisassembler::disassembleOne>(
            "disassembleOne")
        .static_fun<&chromatic::js::NativeDisassembler::disassemble>(
            "disassemble")
        .static_fun<&chromatic::js::NativeDisassembler::analyzeInstruction>(
            "analyzeInstruction")
        .static_fun<&chromatic::js::NativeDisassembler::findXrefs>("findXrefs")
        .static_fun<&chromatic::js::NativeDisassembler::findXrefsInModule>(
            "findXrefsInModule")
        .static_fun<&chromatic::js::NativeDisassembler::findXrefsAsync>(
            "findXrefsAsync")
        .static_fun<&chromatic::js::NativeDisassembler::findXrefsInModuleAsync>(
            "findXrefsInModuleAsync")
        .static_fun<&chromatic::js::NativeDisassembler::filterInstructions>(
            "filterInstructions")
        .static_fun<
            &chromatic::js::NativeDisassembler::filterInstructionsAsync>(
...
template <> struct qjs::js_traits<chromatic::js::NativeFFI> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::NativeFFI &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeFFI> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeFFI>("NativeFFI")
        ...
        .static_fun<&chromatic::js::NativeFFI::destroyCallback>(
            "destroyCallback");
  }
};

template <> struct qjs::js_traits<chromatic::js::NativeInterceptor> {
  static chromatic::js::NativeInterceptor unwrap(JSContext *ctx,
                                                 JSValueConst v) {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::NativeInterceptor &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct qjs::js_traits<chromatic::js::ExceptionContext> {
  static chromatic::js::ExceptionContext unwrap(JSContext *ctx,
                                                JSValueConst v) {
    chromatic::js::ExceptionContext obj;

    obj.type = js_traits<chromatic::js::ExceptionType>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "type"));

    obj.faultAddress = js_traits<uint64_t>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "faultAddress"));

    obj.pc = js_traits<uint64_t>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "pc"));

    obj.accessType = js_traits<chromatic::js::AccessType>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "accessType"));

    return obj;
  }

  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::ExceptionContext &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(
        ctx, obj, "type",
        js_traits<chromatic::js::ExceptionType>::wrap(ctx, val.type));

    JS_SetPropertyStr(ctx, obj, "faultAddress",
                      js_traits<uint64_t>::wrap(ctx, val.faultAddress));

    JS_SetPropertyStr(ctx, obj, "pc", js_traits<uint64_t>::wrap(ctx, val.pc));

    JS_SetPropertyStr(
        ctx, obj, "accessType",
        js_traits<chromatic::js::AccessType>::wrap(ctx, val.accessType));
...
template <> struct qjs::js_traits<chromatic::js::NativeExceptionHandler> {
  static chromatic::js::NativeExceptionHandler unwrap(JSContext *ctx,
                                                      JSValueConst v) {
  ...
  static JSValue
  wrap(JSContext *ctx,
       const chromatic::js::NativeExceptionHandler &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeExceptionHandler> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeExceptionHandler>("NativeExceptionHandler")
        ...
        .static_fun<&chromatic::js::NativeExceptionHandler::isEnabled>(
            "isEnabled")
        .static_fun<&chromatic::js::NativeExceptionHandler::addCallback>(
            "addCallback")
        .static_fun<&chromatic::js::NativeExceptionHandler::removeCallback>(
            "removeCallback")
        .static_fun<&chromatic::js::NativeExceptionHandler::removeAllCallbacks>(
            "removeAllCallbacks");
  }
};

template <> struct qjs::js_traits<chromatic::js::NativeSoftwareBreakpoint> {
  static chromatic::js::NativeSoftwareBreakpoint unwrap(JSContext *ctx,
                                                        JSValueConst v) {
  ...
  static JSValue
  wrap(JSContext *ctx,
       const chromatic::js::NativeSoftwareBreakpoint &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeSoftwareBreakpoint> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeSoftwareBreakpoint>(
           "NativeSoftwareBreakpoint")
        .constructor<>()
        .static_fun<&chromatic::js::NativeSoftwareBreakpoint::set>("set")
        .static_fun<&chromatic::js::NativeSoftwareBreakpoint::remove>("remove")
        .static_fun<&chromatic::js::NativeSoftwareBreakpoint::removeAll>(
            "removeAll");
  }
};

template <> struct qjs::js_traits<chromatic::js::NativeHardwareBreakpoint> {
  static chromatic::js::NativeHardwareBreakpoint unwrap(JSContext *ctx,
                                                        JSValueConst v) {
  ...
  static JSValue
  wrap(JSContext *ctx,
       const chromatic::js::NativeHardwareBreakpoint &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeHardwareBreakpoint> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeHardwareBreakpoint>(
           "NativeHardwareBreakpoint")
        .constructor<>()
        .static_fun<&chromatic::js::NativeHardwareBreakpoint::set>("set")
        .static_fun<&chromatic::js::NativeHardwareBreakpoint::remove>("remove")
        .static_fun<&chromatic::js::NativeHardwareBreakpoint::removeAll>(
            "removeAll")
        .static_fun<&chromatic::js::NativeHardwareBreakpoint::maxBreakpoints>(
            "maxBreakpoints")
        .static_fun<&chromatic::js::NativeHardwareBreakpoint::activeCount>(
            "activeCount");
  }
};

template <> struct qjs::js_traits<chromatic::js::MemoryAccessDetails> {
  static chromatic::js::MemoryAccessDetails unwrap(JSContext *ctx,
                                                   JSValueConst v) {
    ...
    obj.pageBase = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "pageBase"));

    obj.operation = js_traits<std::string>::unwrap(
        ctx, JS_GetPropertyStr(ctx, v, "operation"));

    obj.rangeIndex =
        js_traits<int>::unwrap(ctx, JS_GetPropertyStr(ctx, v, "rangeIndex"));

    return obj;
  }

  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::MemoryAccessDetails &val) noexcept {
    JSValue obj = JS_NewObject(ctx);

    JS_SetPropertyStr(ctx, obj, "address",
                      js_traits<std::string>::wrap(ctx, val.address));

    JS_SetPropertyStr(ctx, obj, "pageBase",
                      js_traits<std::string>::wrap(ctx, val.pageBase));

    JS_SetPropertyStr(ctx, obj, "operation",
                      js_traits<std::string>::wrap(ctx, val.operation));

    JS_SetPropertyStr(ctx, obj, "rangeIndex",
                      js_traits<int>::wrap(ctx, val.rangeIndex));
...
template <> struct qjs::js_traits<chromatic::js::NativeMemoryAccessMonitor> {
  static chromatic::js::NativeMemoryAccessMonitor unwrap(JSContext *ctx,
                                                         JSValueConst v) {
  ...
  static JSValue
  wrap(JSContext *ctx,
       const chromatic::js::NativeMemoryAccessMonitor &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::NativeMemoryAccessMonitor> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::NativeMemoryAccessMonitor>(
           "NativeMemoryAccessMonitor")
        .constructor<>()
        .static_fun<&chromatic::js::NativeMemoryAccessMonitor::enable>("enable")
        .static_fun<&chromatic::js::NativeMemoryAccessMonitor::disable>(
            "disable")
        .static_fun<&chromatic::js::NativeMemoryAccessMonitor::disableAll>(
            "disableAll")
        .static_fun<&chromatic::js::NativeMemoryAccessMonitor::drainPending>(
            "drainPending");
  }
};
...
template <> struct qjs::js_traits<chromatic::js::ScriptLifecycle> {
  ...
  static JSValue wrap(JSContext *ctx,
                      const chromatic::js::ScriptLifecycle &val) noexcept {
    JSValue obj = JS_NewObject(ctx);
...
template <> struct js_bind<chromatic::js::ScriptLifecycle> {
  static void bind(qjs::Context::Module &mod) {
    mod.class_<chromatic::js::ScriptLifecycle>("ScriptLifecycle")
        ...
        .static_fun<&chromatic::js::ScriptLifecycle::removeDisposeCallback>(
            "removeDisposeCallback")
        .static_fun<&chromatic::js::ScriptLifecycle::removeAllDisposeCallbacks>(
